...
from .views import SlotListCreateView,SlotFilterView,SlotDetailView,BookingView,GetBookingsStudent,BookingDeleteView,get_all_bookings,SlotsBookingViewSet
